...
• F1 Shift Lights: Sleek RPM progress bar with a high-intensity blinking shift indicator.

• G-Force Meter: Live longitudinal G-force tracking during launches.
...
3. Add `ensure ox_lib` and `ensure cjs-midnight` to your `server.cfg`.
...
• Hide VBOX: Removes the overlay from your screen.
